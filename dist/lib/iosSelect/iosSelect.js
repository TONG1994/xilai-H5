		...
		initLayer: function () {
			...
			var all_html = [
				'<header style="height: ' + headerHeightCss + '; line-height: ' + headerHeightCss + '" class="iosselect-header">',
					...
					'<h2 id="iosSelectTitle" style="height: ' + headerHeightCss + '; line-height: ' + headerHeightCss + ';display: block;"></h2>',
				'</header>',
			...
			this.selectBtnDom.addEventListener('click', function (e) {
				...
				if(self.options.container==="#weightWrap"){
					Util.LocalStorageSetter("weight",self.selectOneObj.value)
				}else if(self.options.container===".thingWrap"){
                    Util.LocalStorageSetter("thingWrap",self.selectOneObj.value)
				}else {
					return false
				}
			});
